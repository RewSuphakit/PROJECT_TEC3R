      ...
      <div
        ...
        <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-2xl w-full max-w-md transform transition-all hover:shadow-3xl">
          ...
          <button
            ...
            className="w-full mt-3 py-3 bg-white text-gray-600 border-2 border-gray-200 rounded-xl font-semibold hover:bg-gray-50 hover:text-blue-600 hover:border-blue-300 transition-all duration-200 flex items-center justify-center gap-2"
          >
